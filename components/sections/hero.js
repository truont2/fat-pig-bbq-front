...
const Hero = ({ data }) => {
  ...
  <div class="container mx-auto flex px-5 pt-20 items-center justify-center flex-col md:h-3/6 h-screen">
    ...
    <div class="text-center lg:w-2/3 w-full">
      <h1 class="title-font md:text-5xl mb-4 font-medium text-gray-900">{data.title}</h1>
      <p class="mb-8 leading-relaxed md:text-xl">{data.description}</p>
    </div>
  </div>
  )
}
